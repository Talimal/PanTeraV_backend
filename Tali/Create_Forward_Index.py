import json
from Visualization.Tali.TIRP_node_forward import TIRP_node_forward
...
class Create_Forward_Index (object):
    ...
    #     return new_json
    #
    # def get_json_from_data(self,tree_node):
    #     a = self.remap_keys(tree_node)
